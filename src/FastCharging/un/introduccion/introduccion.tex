...
\begin{table}[h!]
    ...
    \begin{tabular}{l c c c c c}
        \toprule
        \thead{\normalsize\bfseries Material} & 
        \thead{\normalsize\bfseries $D$ [cm$^2$/s]} &  
        \thead{\normalsize\bfseries $k^0$ [cm/s]} &
        \thead{\normalsize\bfseries $d$ [cm]} &  
        \thead{\normalsize\bfseries $\log(\Xi)$} & 
        \thead{\normalsize\bfseries $\log(\ell)$} \\
        \midrule
