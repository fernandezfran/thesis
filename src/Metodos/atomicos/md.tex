...
átomos. % Por otro lado, el segundo de los casos es útil considerarlo cuando se tienen nanoestructuras en las cuales los átomos están ordenados de cierta forma que globalmente representan una forma definida y no pueden ser consideradas como una red infinita.
...
El ReaxFF \cite{reaxff} es el potencial interatómico del estado del arte para 
...
En el último tiempo también se han desarrollado potenciales interatómicos de 
