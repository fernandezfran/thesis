...
SOC$_{\max}$ mayor a 0.8 (LCO, LMO y LNMO), mientras que los otros se encuentran
...
\begin{table}[h!]
    ...
    electrodo en 15 y 5 minutos\todo{. Las incertezas fueron obtenidas a través de la propagación numérica de los errores informados en la Tabla \ref{t:dk0}}.} 
