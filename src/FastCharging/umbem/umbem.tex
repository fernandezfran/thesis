...
\begin{figure}[h!]
    \centering
    %\includegraphics[width=0.7\textwidth]{FastCharging/umbem/explicacion.png}
...
\begin{figure}[h!]
    \centering
    %\includegraphics[width=0.7\textwidth]{FastCharging/umbem/UMBEM.png}
...
\begin{figure}[h!]
    \centering
    %\includegraphics[width=0.7\textwidth]{FastCharging/umbem/xiacomp.png}
...
\begin{figure}[h!]
    \centering
    %\includegraphics[width=0.7\textwidth]{FastCharging/umbem/sizes.png}
