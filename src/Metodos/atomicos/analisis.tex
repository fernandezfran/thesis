...
La combinación de las RDFs parciales de la ecuación \ref{eq:prdf} permiten
...
Si una átomo permanece en un sitio por un periodo de tiempo lo 
...
una dirección aleatoria, se dice entonces que el movimiento de la átomo es 
...
La energía de formación $F(\mathbf{r})$ es la energía que se requiere para generar 
una estructura. En particular, para un sistema binario A$_x$B (donde $x$ es la 
