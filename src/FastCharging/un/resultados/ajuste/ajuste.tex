...
\begin{figure}[h!]
    ...
    \label{fig:ajustes}
\end{figure}
Esto también se observa en la Figura \ref{fig:pred_vs_exp},
...
\begin{table}[h!]
    \centering
    \caption{Valores ajustados para $D$ y $k^0$ con su incerteza obtenida a través de la propagación numérica de errores. Para su comparación con los experimentos en ordenes de magnitud, referirse al texto.}
