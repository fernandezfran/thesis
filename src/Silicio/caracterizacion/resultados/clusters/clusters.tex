...
\begin{figure}[h]
    ...
    \begin{subfigure}{.475\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Silicio/caracterizacion/resultados/clusters/cluster-isolated.png}
    ...
    \begin{subfigure}{.475\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Silicio/caracterizacion/resultados/clusters/cluster-nclusters.png}
