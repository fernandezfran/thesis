...
\begin{itemize}
    ...
    \item Se ignoran limitaciones en la transferencia de masa en el electrolito, dado que el coeficiente de difusión de Li$^+$ en este medio es del orden de 10$^{-5}$ cm$^2$/s \todo{\cite{}}, es decir, varios órdenes de magnitud mayor que en cualquiera de los materiales analizados. \todo{Por otro lado, el mismo se encuentra usualmente a altas concentraciones}.
