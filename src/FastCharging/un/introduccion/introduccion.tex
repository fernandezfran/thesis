...
\todo{Eze: Quizás se pueda marcar el SOCmax en la Figura 1.1, como ejemplo ¿en la (a) o en la (b) y (c)?}
...
\begin{figure}[h!]
    ...
    \caption{\done{Figura de mérito definida como el tiempo característico de difusión, 
    $\tau = d^2/D$, propuesta por Xia \textit{et al.} \cite{xia2022}. La líneas
    grises discontinuas indican valores de $\tau$ constante que dividen a los 
...
una jerarquía entre distintos materiales de carga rápida \cite{xia2022}\done{, la 
misma consiste en combinar los efectos de los coeficientes de difusión y los 
