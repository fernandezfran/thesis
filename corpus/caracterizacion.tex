...
cadenas, que pueden verse para una para $x = 3.75$ donde se tiene $CN = 2.05$, por 
ejemplo. El CN de Si-Li y Li-Li presenta valores pequeños para concentraciones 
...
que también puede deducirse de la figura \ref{fig:clusters-nclusters} en la cual 
...
arista (2 átomos), una cara de los poliedros (3 átomos) o cuadrílateros 
...
Li de la primera esfera de coordinación Si-Li comienza a ser importante y la
...
considerada. Ya que en $g_{A-B}(r)$ no hay dependencia angula, $dV$ puede 
...
sistemas de Li$_x$Si ($\theta_{Li-Li}$, $\theta{Si-Si}$ y $\theta_{Si-Li}$), ya
...
\ref{fig:amorfas}. Aunque la presencia de estas cadenas puede inferirse a partir
...
electroquímico de la curva de potencial en función de la concetración de Li. Se 
