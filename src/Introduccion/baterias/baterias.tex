...
\begin{figure}[h!]
    \centering
    \includegraphics[width=.7\textwidth]{Introduccion/baterias/whkg.png}
...
las componentes más relevantes: los electrodos positivo (cátodo, en naranja) y 
negativo (ánodo, en azul) donde ocurren las reacciones redox en la carga/descarga de la celda, el electrolito 
por el cual difunden los iones de litio y el separador (en violeta), que es un material 
...
En la Figura \ref{fig:esquema-bateria}a se presenta la batería completamente cargada, donde los iones de Li (en verde) junto a los electrones (en rojo) se encuentran en el ánodo.
Durante la descarga (ver Figura \ref{fig:esquema-bateria}b), en la cual se utiliza la energía almacenada, la reacción redox es espontánea y 
provoca la difusión de iones de litio por el electrolito desde el ánodo hacia el 
cátodo (flechas verdes), junto con una corriente eléctrica en un circuito externo (flechas rojas). 
Cuando la batería se encuentra completamente descargada, los iones de Li y los electrones de encuentran en el cátodo, como se representa en la Figura \ref{fig:esquema-bateria}c.
Durante la carga se debe aplicar una corriente eléctrica externa para tener la 
reacción inversa (Figura \ref{fig:esquema-bateria}d).
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=.9\textwidth]{Introduccion/baterias/esquema_bateria.png}
    \caption{Esquema de las componentes y el funcionamiento de una batería de 
    ion-litio: (a) Batería completamente cargada, (b) durante la descarga, (c) 
    completamente descargada, y (d) durante la carga.}
...
de aquellos implementados originalmente por Sony. En particular, el salto observado en el año 2005 se debe a la introducción de cátodos de LiFePO$_4$ (LFP). A continuación se mencionan
...
LFP fue introducida como material catódico a fines de la década 
...
a sus ventajas ya ha sido exitosamente comercializado en EVs.
...
ánodos de Si. 
En dicha figura se presentan datos extraídos de la base de datos 
...
observar cualitativamente que la 
\begin{figure}[h!]
    \centering
    ...
    \label{fig:scopus}
\end{figure}
pendiente de crecimiento de publicaciones 
