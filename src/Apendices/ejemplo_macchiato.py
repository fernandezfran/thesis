...
# datos experimentales del corrimiento químico de c-Li13Si4
...
# obtención de los centros de los picos de cada átomo utilizando el modelo
# a primeros vecinos
csc = macchiato.chemical_shift.ChemicalShiftCenters(u)
csc.fit(ppm)

# dados los centros, ajuste del ancho y la altura de los picos para
# coincidir con la precisión experimental
...
plotter = macchiato.chemical_shift.ChemicalShiftSpectra(csc, csw)
