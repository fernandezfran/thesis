...
de Wang \textit{et al.} \cite{wang2019high} \todo{. Estos datos ya se presentaron en la Figura \ref{fig:preproc} y ahora se muestran junto al ajuste en la Figura \ref{fig:ajustes}d.}
...
\todo{Bak \textit{et al.} \cite{bak2011} sintetizaron nanopartículas híbridas de la 
