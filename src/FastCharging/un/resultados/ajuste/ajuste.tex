...
\ref{fig:preproc} y \todo{(ahora en el formato en el cual son ajustados en la Figura 
\ref{fig:ajustes}d) -> quise decir que antes se mostraba el perfil completo (en la fig 1.2 y ahora en el formato en el cual son ajustados, es decir, SOCmax versus C-rate)}.
