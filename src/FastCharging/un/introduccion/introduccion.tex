...
\begin{figure}[h!]
    ...
    discontinuas en la Figura \ref{fig:diagnostico}a)\todo{, los triángulos negros 
...
\begin{figure}[h!]
    ...
    \caption{\todo{Figura de mérito definida como el tiempo característico de difusión, 
...
una jerarquía entre distintos materiales de carga rápida \cite{xia2022}\todo{, la 
