...
las componentes más relevantes: los electrodos positivo (cátodo\todo{, en naranja}) y 
negativo (ánodo\todo{, en azul}) donde ocurren las reacciones redox en la carga/descarga de la celda, el electrolito 
por el cual difunden los iones de litio y el separador \todo{(en violeta)}, que es un material 
...
\todo{En la Figura \ref{fig:esquema-bateria}a se presenta la batería completamente cargada, donde los iones de Li (en verde) junto a los electrones (en rojo) se encuentran en el ánodo.}
Durante la descarga \todo{(ver Figura \ref{fig:esquema-bateria}b), en la cual se utiliza la energía almacenada}, la reacción redox es espontánea y 
provoca la difusión de iones de litio por el electrolito desde el ánodo hacia el 
cátodo \todo{(flechas verdes)}, junto con una corriente eléctrica en un circuito externo (flechas rojas). 
\todo{Cuando la batería se encuentra completamente descargada, los iones de Li y los electrones de encuentran en el cátodo, como se representa en la Figura \ref{fig:esquema-bateria}c.}
...
\begin{figure}[h!]
    ...
    ion-litio\todo{: (a) Batería completamente cargada, (b) durante la descarga, (c) 
...
de aquellos implementados originalmente por Sony. \todo{En particular, el salto observado en el año 2005 se debe a la introducción de cátodos de LiFePO$_4$ (LFP).} A continuación se mencionan
