...
\begin{figure}
    \centering
    %\includegraphics[width=\textwidth]{caracterizacion/fvc.png}
    \caption{Cambio de volumen fraccionario en función de la composición de la 
    aleación. Los valores experimentales de AFM se muestran con puntos azules, la 
    línea recta se corresponde con cálculos de DFT y los círculos rojos son 
...
\begin{figure}
    \centering
    %\includegraphics[width=\textwidth]{caracterizacion/voltaje.png}
