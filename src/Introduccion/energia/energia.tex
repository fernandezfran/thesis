...
entre otras \cite{IEA}. Este aumento de la demanda total de litio para los próximos años también se observa en el resto de los metales y minerales críticos presentes en las distintas componentes de las baterías \cite{IEA}.
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=.7\textwidth]{Introduccion/energia/iea-Li.png}
