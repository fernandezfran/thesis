...
\begin{table}[h!]
    \centering
    \caption{Valores ajustados para $D$ y $k^0$ con su incerteza \todo{obtenida a través de la propagación numérica de errores. Para su comparación con los experimentos en ordenes de magnitud, referirse al texto.}} 
